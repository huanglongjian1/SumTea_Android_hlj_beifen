...
public abstract class FragmentStateAdapter extends
        RecyclerView.Adapter<FragmentStateAdapter.FragmentViewHolder> implements StatefulAdapter {
    // State saving config
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull final FragmentViewHolder holder) {
        placeFragmentInViewHolder(holder);
        gcFragments();
    }
    ...
    /**
     * {@link RecyclerView.ViewHolder} implementation for handling {@link Fragment}s. Used in
